...
<template>
  <div class='flex h-screen bg-gray-950 text-white overflow-hidden'>
    ...
    <!-- ── SIDEBAR ─────────────────────────────────────── -->
    <!-- :class dynamically changes width based on sidebarOpen -->
    <aside
      :class='sidebarOpen ? "w-64" : "w-16"'
      class='bg-gray-900 border-r border-gray-800 flex flex-col transition-all
    ...
    <div class='flex-1 flex flex-col min-w-0 overflow-hidden'>
      ...
      <header class='h-16 bg-gray-900 border-b border-gray-800 flex items-center
        ...
        <div class='relative group'>
          <button class='flex items-center gap-2 hover:bg-gray-800 px-3 py-2
                        rounded-lg transition-colors'>
            <div class='w-7 h-7 bg-purple-700 rounded-full flex items-center
      ...
      <!-- Page content — slot renders the child page -->
...
// v-if logic hides super admin items from regular admins
